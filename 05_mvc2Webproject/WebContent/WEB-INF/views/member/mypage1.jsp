			...
			<legend>내정보</legend>
				...
				<div class="form-group">
					<fieldset>
						...
						<input type="text" id="memberPw" name="memberPw" class="form-control" value="<%=member.getMemberPw()%>">	
					</fieldset>
				</div>
				<div class="form-group">
					<fieldset>
				...
				<div class="form-group">
					<fieldset style="text-align:center">
						...
						<%}else{ %>
						<a href="/deleteMember?memberNo=<%=member.getMemberNo() %>" class="btn btn-outline-danger">회원 탈퇴</a>
						<%} %>
					</fieldset>
				</div>
		</form>
